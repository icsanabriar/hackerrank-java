...
public class QueenAttackTest {
    ...
    public void given_test_case() throws IOException {
        ...
        final String input = "5 3" + SEPARATOR +
                "4 3" + SEPARATOR +
                "5 5" + SEPARATOR +
                "4 2" + SEPARATOR +
                "2 3" + SEPARATOR;
        ...
        final QueenAttack instance = new QueenAttack();
        instance.main(args);
    ...
    @Test
    public void center_test_case() throws IOException {
        ...
        final String expectedOutput = "16" + SEPARATOR;

        final ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
        System.setIn(in);

        QueenAttack.main(args);
