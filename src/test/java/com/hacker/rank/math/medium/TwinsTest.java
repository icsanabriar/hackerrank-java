...
public class TwinsTest {
    ...
    public void given_test_case() throws IOException {
        ...
        final Twins instance = new Twins();
        instance.main(args);
    ...
    public void hidden_test_case() throws IOException {
        ...
        final String input = "599234567 599876543" + SEPARATOR;

        final String expectedOutput = "2028" + SEPARATOR;
    ...
    public void edge_test_case() throws IOException {
        ...
        final String input = "793231275 793692317" + SEPARATOR;

        final String expectedOutput = "1474" + SEPARATOR;
