...
public class TopTest {
    ...
    public void given_test_case() {
        ...
        final String input = "6" + SEPARATOR +
                "1 2 5 3 6 4" + SEPARATOR;

        final String expectedOutput = "1 2 5 6" + SEPARATOR;
    ...
    public void hidden_test_case() {
        ...
        final String input = "15" + SEPARATOR +
                "1 14 3 7 4 5 15 6 13 10 11 2 12 8 9" + SEPARATOR;

        final String expectedOutput = "2 1 14 15 12" + SEPARATOR;
